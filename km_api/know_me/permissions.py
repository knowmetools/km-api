...
class CollectionOwnerHasPremium(permissions.BasePermission):
    """
    Permission class to ensure the owner of some collection has a
    ...
    def has_permission(self, request, view):
        ...
        assert hasattr(view, "get_subscription_owner"), (
            "In order to use the `CollectionOwnerHasPremium` permission, the "
            "view must have a `get_subscription_owner(request, obj)` method "
            "that returns the user who owns the subscription that should be "
            "checked for the given object."
        )

        user = view.get_subscription_owner(request)
...
class ObjectOwnerHasPremium(permissions.BasePermission):
    """
    Permission class to ensure the owner of some object has a premium
    subscription.
    """
    ...
    def has_object_permission(self, request, view, obj):
        ...
        assert hasattr(view, "get_subscription_owner"), (
            "In order to use the `ObjectOwnerHasPremium` permission, the view "
            "must have a `get_subscription_owner(request, obj)` method that "
