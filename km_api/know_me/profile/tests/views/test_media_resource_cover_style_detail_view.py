...
def test_get_permissions():
    ...
    """
    view = views.MediaResourceCoverStyleDetailView()
...
def test_get_queryset(media_resource_cover_style_factory):
    """
...
def test_get_serializer_class():
    """
    The view should use MediaResourceCoverStyleSerializer as its
    serializer class.
    """
    view = views.MediaResourceCoverStyleDetailView()
...
def test_get_subscription_owner():
    """
    The subscription owner for a media resource category should be the user
    who owns the Know Me user who owns the resource category.
    """
    view = views.MediaResourceCoverStyleDetailView()
    request = mock.Mock(name="Mock Request")
    resource = mock.Mock(name="Mock Media Resource Cover Style")
