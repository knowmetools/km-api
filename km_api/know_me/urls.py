...
urlpatterns = [
    ...
    url(r'^groups/(?P<pk>[0-9]+)/$', views.ProfileDetailView.as_view(), name='profile-detail'),          # noqa
    ...
    url(r'^profiles/(?P<pk>[0-9])/groups/$', views.ProfileListView.as_view(), name='profile-list'),      # noqa
    ...
    url(r'^users/(?P<pk>[0-9])/groups/$', views.ProfileListView.as_view(), name='profile-group-list'),      # noqa
]
